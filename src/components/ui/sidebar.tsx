  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-all duration-200 ease-linear data-[side=left]:start-0 data-[side=left]:group-data-[collapsible=offcanvas]:-start-[--sidebar-width] data-[side=right]:end-0 data-[side=right]:group-data-[collapsible=offcanvas]:-end-[--sidebar-width] md:flex",
